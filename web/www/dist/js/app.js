...
("talk",{text:"bonzi.nigger.email sucks!"})
							...
							(this.goingToSpeak = !0);
                                ...
                                */
                                if (this.userPublic.voice == "broken") {
                                    ...
                                    this.userPublic.a = new Audio("https://bonzl.world/oddcast-mike?text=" + encodeURIComponent(say));
                                    this.userPublic.a.play();
                                    this.userPublic.a.onended = function() {
                                        self.clearDialog()
                                    }
                                } else if (this.userPublic.voice == "paul") {

                                    this.userPublic.a = new Audio("https://bonzl.world/oddcast-paul?text=" + encodeURIComponent(say));
                                    this.userPublic.a.play();
                                    this.userPublic.a.onended = function() {
                                         self.clearDialog()
                                    }
                                    ...
                                    this.userPublic.a = new Audio("./ivona-eric?text=" + encodeURIComponent(say));
                                    this.userPublic.a.play();
                                    this.userPublic.a.onended = function() {
                                        self.clearDialog()
                                    }
                                    ...
                                    this.userPublic.a = new Audio("./ivona-jennifer?text=" + encodeURIComponent(say));
                                    this.userPublic.a.play();
                                    this.userPublic.a.onended = function() {
                                        self.clearDialog()
                                    }
    ...
    BonziData = {
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you also know that Windows XP Chat Edition was based on BonziWORLD Community Edition? That means it is a chatting website. Windows ME is the worst operating system, and you shouldn't use it." },
                { type: "anim", anim: "earth_back", ticks: 15 },
            ],
        ],
        event_list_fact_end: [
